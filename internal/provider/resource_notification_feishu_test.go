...
func TestAccNotificationFeishuResource(t *testing.T) {
	...
	webhookURL := "https://open.feishu.cn/open-apis/bot/v2/hook/XXXXXXXXXXXXXXXXXXXX"
	webhookURLUpdated := "https://open.feishu.cn/open-apis/bot/v2/hook/YYYYYYYYYYYYYYYYYYYY"
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccNotificationFeishuResourceConfig(name, webhookURL),
				ConfigStateChecks: []statecheck.StateCheck{
					statecheck.ExpectKnownValue("uptimekuma_notification_feishu.test", tfjsonpath.New("name"), knownvalue.StringExact(name)),
					statecheck.ExpectKnownValue("uptimekuma_notification_feishu.test", tfjsonpath.New("webhook_url"), knownvalue.StringExact(webhookURL)),
					statecheck.ExpectKnownValue("uptimekuma_notification_feishu.test", tfjsonpath.New("is_active"), knownvalue.Bool(true)),
				},
			},
			{
				Config: testAccNotificationFeishuResourceConfig(nameUpdated, webhookURLUpdated),
				ConfigStateChecks: []statecheck.StateCheck{
					statecheck.ExpectKnownValue("uptimekuma_notification_feishu.test", tfjsonpath.New("name"), knownvalue.StringExact(nameUpdated)),
					statecheck.ExpectKnownValue("uptimekuma_notification_feishu.test", tfjsonpath.New("webhook_url"), knownvalue.StringExact(webhookURLUpdated)),
					statecheck.ExpectKnownValue("uptimekuma_notification_feishu.test", tfjsonpath.New("is_active"), knownvalue.Bool(true)),
				},
			},
		},
