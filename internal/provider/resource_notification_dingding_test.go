		...
		Steps: []resource.TestStep{
			{
				...
				ConfigStateChecks: []statecheck.StateCheck{
					statecheck.ExpectKnownValue(
						"uptimekuma_notification_dingding.test",
						tfjsonpath.New("name"),
					...
					statecheck.ExpectKnownValue(
						...
						knownvalue.StringExact("https://oapi.dingtalk.com/robot/send?access_token=abcdefg123456"),
					),
					statecheck.ExpectKnownValue(
						"uptimekuma_notification_dingding.test",
			...
			},
			{
				...
				ConfigStateChecks: []statecheck.StateCheck{
					...
					statecheck.ExpectKnownValue(
						"uptimekuma_notification_dingding.test",
						tfjsonpath.New("secret_key"),
						knownvalue.StringExact(secretKey),
					),
					statecheck.ExpectKnownValue(
						"uptimekuma_notification_dingding.test",
						tfjsonpath.New("mentioning"),
						knownvalue.StringExact(mentioning),
					),
				},
			},
			{
...
func testAccNotificationDingDingResourceConfigWithOptionalFields(
	name string,
	secretKey string,
	mentioning string,
) string {
