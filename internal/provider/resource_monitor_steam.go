...
func (r *MonitorSteamResource) Update(
	...
	if err != nil && !updatedWithoutEvent(&resp.Diagnostics, err, "failed to update Steam monitor") {
		return
	}
...
func (r *MonitorSteamResource) Delete(
	...
	deletedWithoutEvent(&resp.Diagnostics, err, "failed to delete Steam monitor")
}
