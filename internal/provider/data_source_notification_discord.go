...
func (d *NotificationDiscordDataSource) Metadata(
	_ context.Context,
...
func (d *NotificationDiscordDataSource) Schema(
	_ context.Context,
			...
			if notifications[i].Name == data.Name.ValueString() && notifications[i].Type() == "discord" {
				if found != nil {
					resp.Diagnostics.AddError(
						...
						fmt.Sprintf(
							"Multiple Discord notifications with name '%s' found. Please use 'id' to specify the notification uniquely.",
